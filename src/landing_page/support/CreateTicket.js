    ...
    return (
        <div className='container'>
            <div className='row p-5 mt-5 mb-5'>
                <h3 className='mb-2'>To create a ticket, select a relecant topic</h3>
                <div className='col-4 p-5 mt-2 mb-2'>
                    ...
                    <a href='' style={{ textDecoration: "none", lineHeight: "2.5" }}>Get Started</a><br />
                ...
                <div className='col-4 p-5 mt-2 mb-2'>
                    <h5 className=''><i class="fa fa-credit-card" aria-hidden="true"></i>  Funds </h5>
                ...
                <div className='col-4 p-5 mt-2 mb-2'>
                    <h5 className=''><i class="fa fa-circle-o" aria-hidden="true"></i> Coin</h5>
                    ...
                    <a href='' style={{ textDecoration: "none", lineHeight: "2.5" }}>Managing your Portfoilo</a><br />
